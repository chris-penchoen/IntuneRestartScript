...
.DESCRIPTION
    ...
    ## lululemon: A custom log path set in line 46
...
function Write-Log() {
    ...
    param(
        ...
        [Alias('LogPath')]
        ## lululemon: custom log path
        ## [string]$Path = "$env:APPDATA\ToastNotificationScript\New-ToastNotification.log",
        [string]$Path = "$env:APPDATA\lululemon\ToastNotifications\UptimeReboot\logs\lulu-toast-reboot-uptime.log",
        [Parameter(Mandatory=$false)]
...
function Register-CustomNotificationApp($fAppID,$fAppDisplayName) {
    ...
    ## lululemon: changed icon from to "%SystemRoot%\ImmersiveControlPanel\images\logo.png"   to   "%SystemRoot%\ImmersiveControlPanel\images\logo.contrast-white.png"
    ## $IconUri = "%SystemRoot%\ImmersiveControlPanel\images\logo.png"
    $IconUri = "$env:APPDATA\lululemon\ToastNotifications\UptimeReboot\Images\blank_logo.png"
...
##lululemon: The below scenario was customized by adding Snooze button with the dismiss function
...
<toast scenario="$Scenario">
    ...
    <actions>
        <action activationType="protocol" arguments="$Action1" content="$ActionButton1Content" />
        <action activationType="system" arguments="dismiss" content="$SnoozeButtonContent"/>
    </actions>
</toast>
"@
}
##lululemon: The above scenario was customized by adding Snooze button with the dismiss function
