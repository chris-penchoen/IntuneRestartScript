...
.NOTES
    ...
    2.3.1 -   Updated and modified script and config-toast-reboot-uptime.xml for Lululemon specific use case 
                - UptimeConfig.xml hosted on StaticSave temporarily; needs to be hosted on Azure Storage 
                - lululemon-logo-48x48.jpg and ToastHeroImageDefault-2.jpg hosted on Imgur; also need to move to Azure Storage 
                - Current issues: 
...
.LINK
    https://github.com/chris-penchoen/lulu-toast-notification
